...
- Create Angular project with ng: `ng new reinstructible.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`reinstructible.client.esproj`).
